...
function Hero() {
  return (
    <div className="relative xl:bg-white overflow-hidden mt-20 sm:mt-[88px]">
      <div className="bg-[url('../public/images/persons/vps-administrado-portrait.jpeg')] sm:bg-[url('../public/images/persons/vps-administrado-landscape.jpeg')] bg-center bg-blend-screen bg-cover bg-no-repeat bg-gray-700 max-w-screen-2xl mx-auto -md:mx-0 xl:bg-white">
        <div className="relative z-10 py-8 sm:py-16 md:py-20 lg:max-w-screen-md lg:w-full lg:py-28 xl:py-32 h-full xl:bg-white">
          ...
          <main className="py-10 mx-auto px-4 sm:py-12 sm:px-6 md:py-16 lg:py-20 lg:px-8 xl:py-28">
            <div className="sm:text-center lg:text-left">
              <Title start="Tus proyectos mas exigentes " strong="en las mejores manos" />
              <Paragraph
      ...
      <div className="hidden xl:block xl:absolute xl:inset-y-0 xl:right-0 xl:w-1/2">
        <img
          ...
          src="/images/persons/vps-administrado-landscape.jpeg"
