      ...
      <div className="mx-auto max-w-screen-2xl py-24 px-4 sm:px-6 lg:px-8">
        <div className="sm:align-center sm:flex sm:flex-col">
          ...
          <p className="mt-5 text-xl text-gray-300 sm:text-center">
            Crea una marca blanca de alojamiento hoy con el mejor hosting en España de la mano de
            Rackmarkt.
          </p>
        ...
        <div className="my-12 space-y-4 sm:mt-16 sm:grid sm:grid-cols-2 sm:gap-6 sm:space-y-0 lg:mx-auto lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-4">
          {tiers.map((tier) => (
            <div
              key={tier.name}
        ...
        <div className="sm:align-center sm:flex sm:flex-col">
          <p className="mt-5 text-xl text-gray-300 sm:text-center">
            Con un paquete Reseller serás el capitán del barco gestionando las características de
            los productos. Puedes crear los planes de alojamiento que consideres dentro de los
            recursos que tengas contratados, creando cuentas independientes para tus clientes.
          </p>
        </div>
      </div>
    </div>
