export default function HeroSSL() {
  return (
    <div className="relative xl:bg-white overflow-hidden mt-20 sm:mt-16">
      <div className="bg-[url('../public/images/persons/ssl-portrait.jpeg')] sm:bg-[url('../public/images/persons/ssl-landscape.jpeg')] bg-center bg-blend-screen bg-cover bg-no-repeat bg-gray-700 max-w-screen-2xl mx-auto -md:mx-0 xl:bg-white">
          ...
          <main className="py-10 mx-auto px-4 sm:py-12 sm:px-6 md:py-16 lg:py-20 lg:px-8 xl:py-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-white xl:text-gray-700 sm:text-5xl md:text-6xl shadow-gray-900">
                <b className="text-emerald-600">Asegura las comunicaciones</b> en tus conexiones.
              </h1>
      ...
      <div className="hidden xl:block xl:absolute xl:inset-y-0 xl:right-0 xl:w-1/2">
        <img
          ...
          src="/images/persons/ssl-landscape.jpeg"
