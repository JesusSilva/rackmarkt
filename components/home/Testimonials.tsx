      ...
      <div className="relative pb-32 bg-gray-600">
        <div className="absolute inset-0">
          <img
            ...
            src="./images/persons/testimonials.jpeg"
            alt=""
          />
        ...
        <div className="relative max-w-screen-2xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-xl text-emerald-200">
            Nulla tempor labore est incididunt et labore exercitation. Tempor non cillum amet anim
            deserunt ipsum ex amet dolore aliqua aute mollit consectetur cillum. Nostrud est amet in
            anim nisi.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
          {testimonials.map((testimonial) => (
            <div key={testimonial.name} className="flex flex-col bg-white rounded-2xl shadow-xl">
