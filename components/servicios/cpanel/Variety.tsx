            ...
            <div>
              <div className="mt-6">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                  WHM es el encargado de controlar las cuentas de cPanel:
                </h2>
                <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
                  <ul role="list">
                    <li>Analizar y diagnosticar el estado del servidor.</li>
                    <li>Personalizar cPanel con tu marca de proveedor/reseller.</li>
                    <li>Crear, migrar, suspender o eliminar cuentas de cliente.</li>
                    <li>Crear y asignar paquetes de hosting delimitando recursos.</li>
                    <li>Garantizar y vigilar la seguridad del servidor.</li>
                    <li>Mantener actualizado el servidor en todos sus niveles.</li>
                  </ul>
                </div>
                <div className="mt-6">
                  <a
        ...
        <div className="lg:mx-auto lg:grid lg:max-w-screen-2xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
          <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
            <div>
              <div className="mt-6">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                  cPanel es el panel de control para cada cuenta de hosting:
                </h2>
                <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
                  <ul role="list">
                    <li>Publicar y monitorizar páginas y aplicaciones web.</li>
                    <li>Administrar ficheros de tu sitio web.</li>
                    <li>Instalar software CMS</li>
                    <li>
                      Crear cuentas de email, autorespuesta, listas de correo o filtros.
                    </li>
                    <li>Crear y gestionar bases de datos.</li>
                    <li>Gestionar tus dominios y zonas DNS.</li>
                  </ul>
                </div>
                <div className="mt-6">
                  <a
