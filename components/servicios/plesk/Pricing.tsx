...
const tiers = [
  {
    ...
    features: ['Compatible con Cloud/VPS']
  },
  {
    name: 'Pro',
    href: '#',
    ...
    <div className="bg-blue-600">
      <div className="pt-12 sm:pt-16 lg:pt-24">
        <div className="mx-auto max-w-screen-2xl px-4 text-center sm:px-6 lg:px-8">
          <div className="mx-auto max-w-screen-2xl space-y-2 lg:max-w-none">
            ...
            <p className="text-xl text-gray-300">
              Para poder utilizar Plesk, es necesario adquirir la licencia
              correspondiente. Existen varias licencias disponibles y puedes elegir la que
      ...
      <div className="mt-8 bg-gray-50 pb-12 sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-24">
        <div className="relative">
          ...
          <div className="relative z-10 mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-screen-2xl space-y-4 lg:grid lg:grid-cols-3 lg:gap-5 lg:space-y-0">
              {tiers.map((tier) => (
                <div
                  key={tier.name}
