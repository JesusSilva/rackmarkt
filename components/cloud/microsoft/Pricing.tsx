  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-screen-2xl bg-white py-16 sm:py-24 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-5 text-xl text-gray-500 mb-32">
          Microsoft 365 dispone de una variedad de planes pensados para negocios como el tuyo.
          Además, en Rackmarkt somos partners autorizados de Microsoft y te asistiremos en el
          proceso de integración con Microsoft 365 para tu empresa u organización.
        </p>
        {/* xs to lg */}
